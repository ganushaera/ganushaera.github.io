...
// Click-to-enlarge lightbox for real photos (skips placeholder boxes automatically)
(function () {
  const containers = document.querySelectorAll('.gallery-item, .project-media, .blog-post-media');
  ...
  containers.forEach(container => {
    ...
    if (!img) return; // still a placeholder box — nothing to enlarge yet
